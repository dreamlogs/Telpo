...
const UNITS = [
  ...
  { id:"u7", title:"Math Skills & Review", week:5, desc:"Sci notation, sig figs, dimensional analysis, full review.", lectures:[
    { id:"x1", title:"Scientific Notation & Dimensional Analysis", yt:"https://www.youtube.com/watch?v=eCJ76hz7jPM", ytLabel:"The Organic Chemistry Tutor",
      reading:["Scientific notation: coefficient (1-10) \u00d7 10^exponent. 0.00045 = 4.5\u00d710^-4. 6,020,000 = 6.02\u00d710^6. Multiply: multiply coefficients, add exponents. Divide: divide coefficients, subtract exponents.","Sig figs: nonzero digits count. Zeros between nonzero count. Leading zeros do not count. Trailing zeros after decimal count. 0.00302 = 3 sig figs.","Dimensional analysis: multiply by conversion factors so units cancel. Write units at every step. If units do not cancel to your target, the setup is wrong."],
      practice:[{q:"Express 0.0067 in scientific notation",a:"6.7 \u00d7 10^-3"},{q:"(4.0\u00d710^5) / (2.0\u00d710^2) = ?",a:"2.0 \u00d7 10^3. Divide coefficients, subtract exponents"},{q:"Sig figs in 0.04050?",a:"4 sig figs (4, 0, 5, 0)"},{q:"Convert 2.5 hours to seconds",a:"2.5 \u00d7 60 \u00d7 60 = 9000 seconds"}] },
    { id:"x2", title:"Full Review & Test Strategy", yt:"https://www.youtube.com/watch?v=TBt4gvzHEW0", ytLabel:"The Organic Chemistry Tutor",
      reading:["The LBCC chemistry placement is 45 minutes, paper/pencil, no calculator. Pass places you into CHEM 1A, saving a full semester over CHEM 2.","Strategy: read carefully, write units at every step, check that answers make sense. Budget about 1 minute per question. Skip hard ones and come back.","Night before priorities: mole conversions, balancing equations, naming compounds, gas law calculations. These are the most commonly tested areas."],
      practice:[{q:"Molar mass of H2SO4? (H=1, S=32, O=16)",a:"2+32+64 = 98 g/mol"},{q:"Name Fe2(SO4)3",a:"Iron(III) sulfate. 3 sulfates = 6-, so Fe = 3+ each"},{q:"Balance: C2H6 + O2 \u2192 CO2 + H2O",a:"2C2H6 + 7O2 \u2192 4CO2 + 6H2O"},{q:"Volume of 0.25 mol gas at STP?",a:"0.25 \u00d7 22.4 = 5.6 L"}] },
  ]},
];
...
function LectureView({ lecture, status, onStatus, onBack }) {
  const Interactives = { periodic:PeriodicExplorer, shells:ElectronShells, balancer:BalancerGame, molemap:MoleMap, gasSim:GasLawSim, molarity:MolaritySim };
  ...
  return (
    <div>
      ...
      <div style={{ marginTop:12 }}>
        ...
        <a href={lecture.yt} target="_blank" rel="noopener noreferrer" style={{ display:"inline-flex", alignItems:"center", gap:6, marginTop:10, marginBottom:16, padding:"8px 14px", background:C.redDim, borderRadius:6, border:`1px solid rgba(248,113,113,0.2)`, color:C.red, fontSize:12, fontWeight:500, textDecoration:"none" }}>&#9654; Watch on YouTube <span style={{ fontSize:10, color:C.textDim, marginLeft:4 }}>({lecture.ytLabel})</span></a>
        {/* Reading */}
