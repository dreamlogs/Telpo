...
const UNITS = [
  { id:"u1", title:"Atomic Structure & Periodic Table", week:1, desc:"Subatomic particles, electron config, periodic trends, bonding.", lectures:[
    { id:"a1", title:"Atoms, Elements & Subatomic Particles", yt:"https://www.youtube.com/watch?v=5PyVoMnRTlQ", ytLabel:"Professor Dave Explains", interactive:"periodic", eqKey:"atoms",
    ...
    { id:"a2", title:"Electron Configuration & Orbitals", yt:"https://www.youtube.com/watch?v=Aoi4j8es4gQ", ytLabel:"Professor Dave Explains", interactive:"shells", eqKey:"electrons",
    ...
    { id:"a3", title:"Periodic Trends", yt:"https://www.youtube.com/watch?v=hePb00CqvP0", ytLabel:"Professor Dave Explains",
    ...
    { id:"a4", title:"Ions, Ionic & Covalent Bonding", yt:"https://www.youtube.com/watch?v=PoQjsnQmxok", ytLabel:"Professor Dave Explains",
  ...
  { id:"u2", title:"Chemical Nomenclature", week:2, desc:"Naming ionic, covalent compounds, and acids.", lectures:[
    { id:"n1", title:"Naming Ionic Compounds", yt:"https://www.youtube.com/watch?v=mKo72RnN37E", ytLabel:"Professor Dave Explains",
    ...
    { id:"n2", title:"Naming Covalent Compounds", yt:"https://www.youtube.com/watch?v=3agUL7-ezXk", ytLabel:"The Organic Chemistry Tutor",
    ...
    { id:"n3", title:"Naming Acids", yt:"https://www.youtube.com/watch?v=Dqdo0gT5yG0", ytLabel:"Professor Dave Explains",
  ...
  { id:"u3", title:"Chemical Reactions & Balancing", week:2, desc:"Five reaction types, balancing equations, predicting products.", lectures:[
    { id:"r1", title:"Five Types of Chemical Reactions", yt:"https://www.youtube.com/watch?v=iIJD8RNLpS0", ytLabel:"The Organic Chemistry Tutor",
    ...
    { id:"r2", title:"Balancing Chemical Equations", yt:"https://www.youtube.com/watch?v=X7ckfeRjjvI", ytLabel:"Professor Dave Explains", interactive:"balancer",
  ...
  { id:"u4", title:"The Mole & Stoichiometry", week:3, desc:"Mole conversions, stoichiometry, limiting reagent, percent yield.", lectures:[
    { id:"m1", title:"The Mole, Molar Mass & Conversions", yt:"https://www.youtube.com/watch?v=H3VKLRNAQuY", ytLabel:"Professor Dave Explains", interactive:"molemap", eqKey:"mole",
    ...
    { id:"m2", title:"Stoichiometry & Limiting Reagent", yt:"https://www.youtube.com/watch?v=dodsvTfqWNc", ytLabel:"Professor Dave Explains", eqKey:"stoich",
  ...
  { id:"u5", title:"Gas Laws", week:4, desc:"Boyle's, Charles's, ideal gas law.", lectures:[
    { id:"g1", title:"Gas Laws: Boyle's, Charles's, Combined", yt:"https://www.youtube.com/watch?v=robEY-idcLU", ytLabel:"Professor Dave Explains", interactive:"gasSim", eqKey:"gas",
    ...
    { id:"g2", title:"Ideal Gas Law (PV=nRT)", yt:"https://www.youtube.com/watch?v=jbmOcH1fFKs", ytLabel:"Professor Dave Explains", eqKey:"gas",
  ...
  { id:"u6", title:"Solutions & Concentration", week:4, desc:"Molarity and dilution calculations.", lectures:[
    { id:"s1", title:"Molarity & Dilution", yt:"https://www.youtube.com/watch?v=QYK3Aj-IUIs", ytLabel:"Professor Dave Explains", interactive:"molarity", eqKey:"molarity",
  ...
  { id:"u7", title:"States of Matter & Thermochemistry", week:3, desc:"Phase changes, exothermic vs endothermic, heat and energy.", lectures:[
    { id:"ph1", title:"States of Matter & Phase Changes", yt:"https://www.youtube.com/watch?v=oc0ypeDELb0", ytLabel:"Professor Dave Explains", interactive:"heatingCurve",
    ...
    { id:"ph2", title:"Exothermic vs Endothermic Reactions", yt:"https://www.youtube.com/watch?v=ZVhJ4TO8a-M", ytLabel:"Professor Dave Explains", interactive:"activationE",
  ...
  { id:"u8", title:"Lewis Structures & Octet Rule", week:3, desc:"Dot structures, bonding, octet exceptions.", lectures:[
    { id:"lw1", title:"Lewis Dot Structures", yt:"https://www.youtube.com/watch?v=Sk7W2VgbhOg", ytLabel:"Professor Dave Explains", interactive:"lewis",
    ...
    { id:"lw2", title:"Octet Rule and Exceptions", yt:"https://www.youtube.com/watch?v=96L6_IwyHRM", ytLabel:"The Organic Chemistry Tutor", interactive:"lewis",
  ...
  { id:"u9", title:"Equilibrium & Le Chatelier's", week:4, desc:"Keq, shifting equilibrium, Le Chatelier's principle.", lectures:[
    { id:"eq1", title:"Chemical Equilibrium & Keq", yt:"https://www.youtube.com/watch?v=1GiZzCzmO5Q", ytLabel:"Professor Dave Explains",
    ...
    { id:"eq2", title:"Le Chatelier's Principle", yt:"https://www.youtube.com/watch?v=XmgRRmxS3is", ytLabel:"Professor Dave Explains", interactive:"eqShift",
  ...
  { id:"u10", title:"Kinetics & Reaction Rates", week:4, desc:"Collision theory, activation energy, factors affecting rate.", lectures:[
    { id:"kn1", title:"Reaction Rates & Collision Theory", yt:"https://www.youtube.com/watch?v=fEXq_RvnYgI", ytLabel:"Professor Dave Explains", interactive:"activationE",
  ...
  { id:"u11", title:"Math Skills & Review", week:5, desc:"Sci notation, sig figs, logarithms, dimensional analysis, full review.", lectures:[
    { id:"x1", title:"Scientific Notation, Sig Figs & Logarithms", yt:"https://www.youtube.com/watch?v=AGxOWIuaBP8", ytLabel:"Professor Dave Explains",
...
function ToolBar({ activeInteractive }) {
  ...
  const selectTool = (key) => {
    if (activeTool === key) { setActiveTool(null); }
    else { setActiveTool(key); setOpen(false); setScale(1); }
  };
    ...
    <>
      ...
      <div style={{ position:"fixed", top:16, right:16, zIndex:100 }}>
        <button onClick={() => { setOpen(!open); }} style={{
          width:38, height:38, borderRadius:8, border:`1px solid ${open || activeTool ? activeColor : "#262c3e"}`,
          background: open || activeTool ? "rgba(96,165,250,0.12)" : "rgba(20,24,33,0.9)",
          cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center",
          backdropFilter:"blur(8px)", transition:"all 0.2s",
          boxShadow: open ? `0 0 16px rgba(96,165,250,0.2)` : "0 2px 8px rgba(0,0,0,0.3)",
        }}>
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            <path d="M9 2L10.5 6H14.5L11.5 8.5L12.5 12.5L9 10L5.5 12.5L6.5 8.5L3.5 6H7.5L9 2Z" stroke={open || activeTool ? activeColor : iconColor} strokeWidth="1.2" fill={open || activeTool ? `${activeColor}22` : "none"}/>
          </svg>
        </button>

        {/* Dropdown panel - only show when no tool is active OR explicitly opened */}
        {open && !activeTool && (
          <div style={{
            ...
            {TOOL_LIST.map(tool => {
              ...
              return (
                ...
                >
                  ...
                  <span style={{
                    fontSize:11, color: isMatch ? "#d4d2cb" : "#8a8b93",
        ...
        {/* Active tool label chip (shows when a tool is open and dropdown is closed) */}
        {activeTool && !open && (
          <div style={{
            position:"absolute", top:44, right:0, display:"flex", alignItems:"center", gap:6,
            background:"rgba(16,19,26,0.95)", border:`1px solid #262c3e`,
            borderRadius:6, padding:"4px 8px", backdropFilter:"blur(8px)",
          }}>
            <span style={{ fontSize:9, color:activeColor, fontWeight:600, whiteSpace:"nowrap" }}>
              {TOOL_LIST.find(t => t.key === activeTool)?.label}
            </span>
            <button onClick={() => setActiveTool(null)} style={{
              background:"none", border:"none", color:"#5a5c66", fontSize:10, cursor:"pointer", padding:0,
            }}>{"\u2715"}</button>
          </div>
        )}

        {/* Back to list when dropdown opened while tool is active */}
        {open && activeTool && (
          <div style={{
            position:"absolute", top:44, right:0, width:210,
            background:"rgba(16,19,26,0.95)", border:`1px solid #262c3e`,
            ...
            <p style={{ fontSize:9, fontWeight:600, color:"#5a5c66", letterSpacing:1.5, textTransform:"uppercase", margin:"6px 12px 4px", padding:0 }}>Switch Tool</p>
            {TOOL_LIST.map(tool => {
              const isActive = activeTool === tool.key;
              return (
                <button key={tool.key} onClick={() => { selectTool(tool.key); setOpen(false); }}
                  style={{
                    width:"100%", display:"flex", alignItems:"center", gap:8,
                    padding:"7px 12px", border:"none", cursor:"pointer",
                ...
                >
                  ...
                  <span style={{ fontSize:11, color: isActive ? activeColor : "#8a8b93", fontWeight: isActive ? 600 : 400 }}>
                    {tool.label}
                  </span>
                </button>
              );
            })}
            <div style={{ borderTop:"1px solid #262c3e", margin:"4px 0" }} />
            <button onClick={() => { setActiveTool(null); setOpen(false); }} style={{
              width:"100%", padding:"7px 12px", border:"none", cursor:"pointer",
              background:"transparent", fontFamily:F.sans, fontSize:11, color:"#f87171", textAlign:"left",
            }}>Close tool</button>
          </div>
        )}
      </div>
      ...
      {activeTool && ToolComp && (
        <div style={{
          ...
          top: fullscreen ? 0 : 62, right: fullscreen ? 0 : 16,
          ...
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:8, gap:8 }}>
            <span style={{ fontSize:12, fontWeight:600, color:"#6a7fa8" }}>
              {TOOL_LIST.find(t => t.key === activeTool)?.label}
            </span>
            <div style={{ display:"flex", alignItems:"center", gap:6 }}>
              {/* Scale control */}
              <span style={{ fontSize:9, color:"#5a5c66" }}>Scale</span>
              <input type="range" min={0.6} max={1.5} step={0.05} value={scale}
                onChange={e => setScale(parseFloat(e.target.value))}
                style={{ width:60, accentColor:"#6a7fa8", height:2, cursor:"pointer" }} />
              <span style={{ fontSize:9, color:"#5a5c66", fontFamily:F.mono, width:28 }}>{Math.round(scale*100)}%</span>
              {/* Fullscreen toggle */}
              ...
              {/* Close */}
              <button onClick={() => { setActiveTool(null); setFullscreen(false); setScale(1); }} style={{
